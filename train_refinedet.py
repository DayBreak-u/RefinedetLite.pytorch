...
from models.refinedet_snet146 import build_refinedet
...
parser.add_argument('--save_folder', default='weights/RefineDet320',
...
def train():
    ...
    if not args.resume:
        ...
        # refinedet_net.extras[0].apply(weights_init)
        # refinedet_net.extras[1].apply(weights_init)
